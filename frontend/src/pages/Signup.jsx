    ...
    <div className="min-h-screen flex items-center justify-center bg-[#020617] text-slate-200 px-4 relative overflow-hidden">
      ...
      <div className="bg-[#0b0f19]/90 border border-slate-800 p-8 rounded-2xl shadow-2xl w-full max-w-md space-y-6 relative z-10 backdrop-blur-md">
        ...
        <div className="text-center">
          ...
          <h2 className="text-3xl font-extrabold text-slate-100 tracking-tight mt-2">Create Account</h2>
          <p className="text-slate-400 text-sm mt-1">Start your gamified fitness journey today.</p>
        </div>
        ...
        <p className="text-center text-sm text-slate-400 mt-4">
          ...
          <button onClick={onSwitchToLogin} className="text-red-400 hover:underline font-semibold cursor-pointer">
            Login
          </button>
        </p>
      </div>
